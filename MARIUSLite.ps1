...
function Show-UsbAnalyzer {
    ...
    $aW = 620; $aStartX = 28; $aTileW = 556; $aTileH = 58; $aSpacing = 3
    ...
    $scanBtn.Add_Paint({
        ...
        $g.DrawString("Scan USB Devices", $tf, $wb, 20, 12)
        $g.DrawString("Analyze all connected USB input devices", $df, $rb, 20, 35)
    ...
    $exitBtn.Add_Paint({
        ...
        $wb = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::White)
        $rb = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::Red)
        $g.DrawString("Exit", $tf, $wb, 20, 12)
        $g.DrawString("Close this application", $df, $rb, 20, 35)
        $wb.Dispose(); $rb.Dispose(); $tf.Dispose(); $df.Dispose()
    })
