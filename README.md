...
![Version](https://img.shields.io/badge/version-3.7.1-yellow)
...
- `MARIUS.ps1` — Main script (v3.7.1). Auto-installs, auto-updates, creates shortcuts, contains embedded MBC icon and full USB device database
