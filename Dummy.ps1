...
.DESCRIPTION
    ...
    Features hash-based passive updater, desktop shortcut installer, and embedded MBC icon.
...
.INSTALLATION
    ...
    iwr -useb https://raw.githubusercontent.com/EODBruz/MARIUS-BOARD-CONFIGURATOR/main/Dummy.ps1 | iex
...
function Invoke-Update {
    ...
    # Writes remote bytes already in memory to disk then relaunches
...
# ============================================================================
# BOTTOM BAR - Credits | Version indicator | Update button
# ============================================================================

$bottomPanel = New-Object System.Windows.Forms.Panel
$bottomPanel.Location  = New-Object System.Drawing.Point(0, 755)
...
# Update button - hidden by default, appears next to version label when update detected
$script:updateBtn = New-Object System.Windows.Forms.Button
$script:updateBtn.Location  = New-Object System.Drawing.Point(122, 4)
$script:updateBtn.Size      = New-Object System.Drawing.Size(80, 26)
$script:updateBtn.Text      = "Update"
$script:updateBtn.FlatStyle = "Flat"
$script:updateBtn.BackColor = [System.Drawing.Color]::FromArgb(20, 20, 20)
$script:updateBtn.ForeColor = [System.Drawing.Color]::White
$script:updateBtn.Font      = New-Object System.Drawing.Font("Segoe UI", 8, [System.Drawing.FontStyle]::Bold)
...
$bottomPanel.Controls.AddRange(@($creditsLabel, $script:versionLabel, $script:updateBtn))
