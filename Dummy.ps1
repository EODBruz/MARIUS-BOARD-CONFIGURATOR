...
# Holds remote bytes in memory so Update button reuses them - no double download
$script:RemoteBytes    = $null
...
function Start-UpdateCheck {
    ...
    $runspace.Open()
    # Hash whichever file is actually running - AppData copy if installed, otherwise the script itself
    $runningScript = if ($MyInvocation.ScriptName -and (Test-Path $MyInvocation.ScriptName)) {
        $MyInvocation.ScriptName
    } elseif (Test-Path $script:InstallPath) {
        $script:InstallPath
    } else { "" }

    $runspace.SessionStateProxy.SetVariable('InstallPath', $runningScript)
...
function Invoke-Update {
    ...
    param([System.Windows.Forms.Button]$UpdateButton)
    try {
        if (-not $script:RemoteBytes -or $script:RemoteBytes.Length -lt 10000) {
            [System.Windows.Forms.MessageBox]::Show(
                "Update data not ready yet. Please wait a moment and try again.",
                "Not Ready", [System.Windows.Forms.MessageBoxButtons]::OK,
        ...
        [System.Windows.Forms.MessageBox]::Show(
            "Update failed: $_`n`nCheck your internet connection and try again.",
...
$script:rgbTimer.Add_Tick({
    ...
    foreach ($ctrl in $script:mainPanel.Controls) {
        if ($ctrl -is [System.Windows.Forms.Button] -and $ctrl.Tag -ne "no-rgb") {
...
# ============================================================================
# BOTTOM BAR - Version | Update button | Credits (painted centred)
# ============================================================================

$bottomPanel = New-Object System.Windows.Forms.Panel
$bottomPanel.Location  = New-Object System.Drawing.Point(0, 758)
$bottomPanel.Size      = New-Object System.Drawing.Size(850, 30)
$bottomPanel.BackColor = [System.Drawing.Color]::Black

# Version label - bottom left
$script:versionLabel = New-Object System.Windows.Forms.Label
$script:versionLabel.Location  = New-Object System.Drawing.Point(4, 0)
$script:versionLabel.Size      = New-Object System.Drawing.Size(90, 30)
...
# Update button - right next to version label, hidden until update detected
$script:updateBtn = New-Object System.Windows.Forms.Button
$script:updateBtn.Location  = New-Object System.Drawing.Point(790, 2)
$script:updateBtn.Size      = New-Object System.Drawing.Size(58, 26)
$script:updateBtn.Text      = "Update"
$script:updateBtn.FlatStyle = "Flat"
$script:updateBtn.BackColor = [System.Drawing.Color]::FromArgb(180, 20, 20)
$script:updateBtn.ForeColor = [System.Drawing.Color]::White
$script:updateBtn.Font      = New-Object System.Drawing.Font("Segoe UI", 7, [System.Drawing.FontStyle]::Bold)
$script:updateBtn.FlatAppearance.BorderColor = [System.Drawing.Color]::FromArgb(220, 50, 50)
$script:updateBtn.FlatAppearance.BorderSize  = 1
$script:updateBtn.Cursor  = [System.Windows.Forms.Cursors]::Hand
$script:updateBtn.Visible = $false
$script:updateBtn.Tag     = "no-rgb"

$script:updateBtn.Add_Click({
    Invoke-Update -UpdateButton $script:updateBtn
})

# Credits - painted directly onto the panel so they are always truly centred
$bottomPanel.Add_Paint({
    ...
    $sf.LineAlignment = [System.Drawing.StringAlignment]::Center
    $rect = New-Object System.Drawing.RectangleF(0, 0, $sender.Width, $sender.Height)
    $g.DrawString("Created by: @mariusheier | Script by: @EODBruz", $font, $brush, $rect, $sf)
    $font.Dispose()
    $brush.Dispose()
})

$bottomPanel.Controls.AddRange(@($script:versionLabel, $script:updateBtn))
...
# Fire async hash check after window is visible - no blocking on startup
$form.Add_Shown({
    $form.Activate()
    Start-UpdateCheck -VersionLabel $script:versionLabel -UpdateButton $script:updateBtn
})
